...
SettingsSurface {
    ...
    rows: [
        ...
        { item: scaleRow, kind: "seg", vals: [0.9, 0.95, 1.0, 1.05, 1.1, 1.25], get: function () { return Flags.uiScale; }, set: function (v) { Flags.uiScale = v; } },
    ...
    Column {
        ...
        SettingsRow {
            ...
            SettingsSeg {
                s: root.s
                options: [{ label: "90%", value: 0.9 }, { label: "95%", value: 0.95 }, { label: "100%", value: 1.0 }, { label: "105%", value: 1.05 }, { label: "110%", value: 1.1 }, { label: "125%", value: 1.25 }]
                value: Flags.uiScale
        ...
        SettingsRow {
            ...
            name: "Font"
            icon: "type"
            sub: Flags.uiFont.length > 0 ? Flags.uiFont : "SF Pro Display"
            last: true
